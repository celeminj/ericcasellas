  ...
  <nav class="navbar-container">
    ...
    <div class="center">
      ...
      <div v-if="user">
        ...
        <router-link to="/addpictures" class="nav-link">Add Pictures</router-link>
      </div>
...
export default {
  ...
  created() {
    this.checkUser();
    window.addEventListener('login', this.checkUser);
  ...
  beforeUnmount() {
    window.removeEventListener('login', this.checkUser);
  },
  methods: {
    checkUser() {
